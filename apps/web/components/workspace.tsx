...
export function Workspace({ email }: { email: string }) {
  ...
  return (
    <div className="workspace-shell min-h-screen">
      ...
      <main className={`workspace-main flex min-h-screen min-w-0 flex-1 flex-col md:h-dvh md:min-h-0 md:overflow-hidden ${isSidebarCollapsed ? "md:ml-16 md:w-[calc(100%-4rem)]" : "md:ml-64 md:w-[calc(100%-16rem)]"}`}>
