...
export function ProjectView({
  ...
  function addTag() {
    ...
    setTagSuggestions((current) => current.some((item) => item.name.toLowerCase() === tag.toLowerCase()) ? current : [...current, { id: `pending-${tag.toLowerCase()}`, name: tag, color: "default" }]);
